    ...
    <div className="bg-ui-bg-subtle p-2 rounded-lg border border-ui-border-base">
      <div className="space-y-1.5">
        ...
        <div className="flex justify-between gap-1">
          ...
          ></div>
          <div className="bg-ui-bg-component h-1 rounded-full w-fit flex-grow"></div>
        </div>
      </div>
    </div>
  )
...
function FreeShippingPopup({
  ...
  return (
    ...
    >
      <div>
        <Button
          className="rounded-full bg-ui-contrast-bg-base text-ui-fg-on-inverted shadow-none outline-none border-none text-[15px] p-2"
      ...
      <div className="w-[400px] bg-ui-contrast-bg-base text-ui-fg-on-inverted p-6 rounded-lg ">
        <div className="pb-4">
          <div className="space-y-3">
            <div className="flex justify-between text-[15px] text-ui-fg-subtle">
              ...
              >
                Only{" "}
                <span className="text-ui-fg-on-inverted">
                  {convertToLocale({
                    amount: price.target_remaining,
                    currency_code: cart.currency_code,
                  })}
            ...
            <div className="flex justify-between gap-1">
              <div
                ...
                style={{ width: `${price.remaining_percentage}%` }}
              ></div>
              <div className="bg-ui-bg-component h-1.5 rounded-full w-fit flex-grow"></div>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-3">
          <LocalizedClientLink
            className="rounded-2xl bg-transparent shadow-none outline-none border-[1px] border-ui-border-interactive text-ui-fg-on-inverted text-[15px] py-2.5 px-4"
            href="/cart"
          >
            View cart
          </LocalizedClientLink>
          ...
          <LocalizedClientLink
            className="flex-grow rounded-2xl bg-ui-button-inverted text-ui-contrast-fg-primary shadow-none outline-none border-[1px] border-ui-button-inverted text-[15px] py-2.5 px-4 text-center"
            href="/store"
          >
            View products
          </LocalizedClientLink>
